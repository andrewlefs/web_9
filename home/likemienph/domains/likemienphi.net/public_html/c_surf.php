...
function loaded(functionName){ if(document.getElementById && document.getElementById(counterName) != null){ functionName(); }else{if(!pageLoaded){ setTimeout('loaded('+functionName+')',100); }}}
