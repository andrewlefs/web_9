...
<div class="header">
	<div class="cont_header">
		...
		<a href="<?=WEB_DOMAIN?>" title="Tang like facebook mien phi"><h1 onclick="location='<?=WEB_DOMAIN?>'" id="js_logo"><img src="<?=WEB_DOMAIN?>/theme/images/logo-hoanggia-net-vn.png" alt="Tang like facebook mien phi" border="0"/></h1></a>
            </div>
		<div class="nav_top">
                    <div class="banner_980">
                    <ul>
