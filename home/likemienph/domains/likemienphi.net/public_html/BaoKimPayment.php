...
class BaoKimPayment 
{
	...
	// Mã merchante site 
	private $merchant_id = '9698';	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

	// Mật khẩu bảo mật
	private $secure_pass = '08ecdfd15c2fca3a'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
